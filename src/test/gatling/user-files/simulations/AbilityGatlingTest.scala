...
/**
 * Performance test for the Ability entity.
 */
class AbilityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Ability entity")
        ...
        .repeat(2) {
            ...
            .exec(http("Delete created ability")
            .delete("${new_ability_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
